...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <section class="content-header">
        <h1>Coneptos mensuales
       
                        <small>listado de conceptos que representan ingresos o egresos a los equipos o trabajos</small>
        </h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Valores mensuales</li>
        </ol>
    </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <h2>
                                    <small>Pertenece a
                                            <label>
                                                <asp:Label Text="" ID="lbl_concepto_padre" runat="server" /></label>
                                        del tipo
                                            <label>
                                                <asp:Label Text="" ID="lbl_tipo_concepto" runat="server" /></label>
                                    </small>
                                </h2>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <h2>
                                    <small>Pertenece a
                                            <label>
                                                <asp:Label Text="" ID="lbl_padre_concepto" runat="server" /></label>
                                        del tipo
                                            <label>
                                                <asp:Label Text="" ID="lbl_tipo_padre_concepto" runat="server" /></label>
                                    </small>
                                </h2>
                            </div>
                        </div>
